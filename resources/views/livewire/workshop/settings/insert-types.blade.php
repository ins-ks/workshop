...
<button onClick="showHideModal('insertType',20,-400)" type="button"
    ...
    <input
        ...
        <div class="flex items-center w-fit mt-2 ">
            <button wire:click = "insertType" class="bg-sky-500 px-3 py-1 mx-auto mt-2 text-xs rounded text-white">insert</button>
        ...
        <script>
             window.addEventListener('typeInserted', event => {
                showHideModal('insertType',20,-400)
            });
        </script>
</div>