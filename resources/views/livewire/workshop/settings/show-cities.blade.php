<div>
    <table id="countriesTable" class="w-full mx-auto">
        ...
        <tr class="border-t border-gray-200" style="border-top-width: 0.01em">
                ...
                <td>
                    <button wire:click = "show({{$city->id}})" onClick="showHideModal('editCity',-400,0)"><i class="fa-solid fa-pen-to-square"></i></button>
    ...
    <button onClick="showHideModal('editCity',20,-400)" type="button"
    ...
    <script>
        window.addEventListener('cityUpdated', event => {
           showHideModal('editCity',20,-400)
       });
   </script>
</div>
